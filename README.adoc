...
A fork of https://github.com/asciidoctor/asciidoctor-chrome-extension that live previews asciidoc in chrome/chromium but also allows you switch between attributes.adoc files, so you can see how your module will look when published. 
